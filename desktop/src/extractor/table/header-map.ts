export const HEADER_HINTS = {
  position: ["pos", "position", "pos.", "no", "no."],
  article: ["artikel", "artikelnummer", "art.-nr", "artnr", "artikel-nr", "item"],
  description: [
    "bezeichnung",
    "beschreibung",
    "produkt",
  ...
  quantity: ["menge", "mge", "anzahl", "qty", "quantity"],
  unit: ["einheit", "einh", "me", "unit", "uom"],
  unitPrice: [
    "einzelpreis",
    "e.-preis",
    "e-preis",
